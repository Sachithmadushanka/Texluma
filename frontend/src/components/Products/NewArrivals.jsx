...
const NewArrivals = () => {
  ...
  const updateScrollButtons = () => {
    ...
    if(container){
        ...
        // Left button: disabled when at the beginning
        setCanScrollLeft(scrollLeft > 0);
        
        // Right button: disabled when at the end
        const rightScrollable = scrollLeft < (scrollWidth - clientWidth - 1); // Added -1 for rounding
    ...
    <section className='py-16 px-4 lg:px-0 '>
        <div className='container mx-auto text-center mb-10 relative'>
            ...
            <p className="text-lg text-gray-600 mb-8">
                Discover the latest styles straights off the runway, freshly added to our collection.
            </p>
            {/* scrolling buttons */}
