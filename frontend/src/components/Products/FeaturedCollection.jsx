  ...
  return (
    <section className='py-16 px-4 lg:px-8'>
        <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center bg-green-50 rounded-3xl">
            ...
            <div className="lg:w-1/2 px-8 py-8 text-center lg:text-left">
                ...
                <p className='text-lg text-gray-600 mb-6'>
                    Discover high-quality apparel designed to keep you comfortable and stylish all day long. 
                    Our collection features soft fabrics, modern fits, and versatile designs perfect for any occasion.
                </p>
