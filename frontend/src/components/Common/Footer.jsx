   ...
   <footer className='border-t py-12'>
    <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
        <div>
            ...
            {/* Newsletter form */}
            <form className='flex'>
                <input type="email" placeholder='Enter your email' className='p-3 w-full text-sm border-t border-l border-b border-gray-300 rounded-l-md focus:outline-none focus:ring-2 
        ...
        <div>
            ...
            <div className="flex items-center space-x-4 mb-6">
                ...
                <a href="https://instagram.com" target='_blank' rel='noopener noreferre'className='hover:text-gray-500'>
                    <IoLogoInstagram className='h-5 w-5'/>
                </a>
                <a href="https://twitter.com" target='_blank' rel='noopener noreferre'className='hover:text-gray-500'>
    ...
    <div className="container mx-auto mt-12 px-4 lg:px-0 border-t border-gray-300 pt-6">
        <p className='text-gray-500 text-sm tracking-tighter text-center'>
            @ 2025 Texluma. All rights reserved.
        </p>
    </div>
   </footer>
  )
